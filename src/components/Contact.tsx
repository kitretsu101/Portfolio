        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="mb-8">
              ...
              <p className="text-gray-400">Get in touch for opportunities or just to say hi!</p>
            </div>

            <div className="group flex items-start gap-4 p-6 glass-card-premium rounded-2xl hover:border-red-500/50 transition-all duration-300">
            ...
            <form className="space-y-5">
              <div>
                <input
                  ...
                  className="w-full px-5 py-4 bg-gray-900/60 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-red-500 transition-colors duration-300"
                />
              </div>
              <div>
                <input
              ...
              <div>
                <textarea
                  ...
                  className="w-full px-5 py-4 bg-gray-900/60 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-red-500 transition-colors duration-300 resize-none"
                ></textarea>
              </div>
              <button
                type="submit"
                className="w-full px-8 py-4 bg-gradient-to-r from-red-500 to-crimson-600 hover:from-red-600 hover:to-crimson-700 text-white font-bold rounded-xl transition-all duration-300 glow-red-strong hover:glow-red-intense hover:scale-[1.02]"
              >
                Send Message
              </button>
            </form>
